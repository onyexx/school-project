...
public class Personalinformation {
	...
	public static void infoDetails(Scanner scan) {
		...
		info = "INSERT INTO personalinformation(employer_name,occupation,employment_duration,gross_income,net_income,gross_monthly_expenses,company_street_name,company_suburb,company_city,postal_code,bank_name,branch_name,branch_code,account_holder,account_type,account_no,debit_date,customer_id) "
				+ "VALUES('"+employer_name+"','"+occupation+"','"+employment_duration+"','"+gross_income+"','"+net_income+"','"+gross_monthly_expenses+"','"+company_street_name+"','"+company_suburb+"','"+company_city+"',"+postal_code+","
						+ "'"+bank_name+"','"+branch_name+"',"+branch_code+",'"+account_holder+"','"+account_type+"',"+account_no+","+debit_date+","+customer_id+")";
